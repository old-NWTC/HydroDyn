...
\node[anchor=center,process]
      (Equation)  at ($(W1Data)!.5!(W2Data)+(0mm,-55mm)$) {$A_m A^*_m ~ F^\text{-}_k(\omega_{m},\omega_{m},\beta_{m},\beta_{m}) \cdot \Delta\omega$};

\draw[red] ($(Equation)+(2mm,0mm)$) ellipse [x radius=17mm, y radius=5mm];
